...
".venv\Scripts\python.exe" -c "import sys,streamlit,cryptography,pandas,pymupdf,docx,openpyxl,reportlab; assert sys.version_info >= (3,11); assert tuple(map(int,streamlit.__version__.split('.')[:2])) >= (1,62)" >nul 2>nul
if errorlevel 1 (
